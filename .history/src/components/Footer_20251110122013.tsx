    ...
    <footer className="border-t border-slate-800 py-12 bg-slate-950">
      <div className="container mx-auto px-4">
          ...
          <div className="flex flex-col items-center md:items-start">
            <h3 className="text-2xl mb-4 text-white">
              <span className="text-xl text-white">
                <span className="text-green-400 text-2xl">Q</span>uick
                <span className="text-green-400 text-2xl">S</span>olution
              </span>
            </h3>
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <ul className="space-y-3 text-slate-400 text-sm">
              ...
              <li className="flex items-center gap-2 justify-center md:justify-start">
                ...
                <span>francolucap1@gmail.com</span>
              </li>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
          ...
          <p className="text-slate-500 text-sm">
            Created by <a href='https://www.deamondd.com' target='_blank' className='hover:text-violet-700'>DeamonDD</a>
          </p>
          </div>
        </div>
