...
const WHATSAPP_NUMBER = '5491123456789'; // Reemplaza con tu número de WhatsApp

// Mensaje predefinido para WhatsApp
const WHATSAPP_MESSAGE = 'Hola, queria soliciar la prueba de comandas QuickSolution.';
    ...
    <section id="demo" className="py-24 relative overflow-hidden bg-slate-900/30">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          >
           <a href='#contacto'>Solicitar Demo Completa</a> 
          </motion.button>
        </motion.div>
      </div>
